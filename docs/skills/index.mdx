...
description: Alfr3d skills system introduction
---
...
Alfr3d offers multiple ways to acquire skills:

- **Alfr3d Skill Hub** — Browse and install community skills via `/skill list --remote`
...
1. **Workspace skills** (highest): `~/alfr3d/skills/`
