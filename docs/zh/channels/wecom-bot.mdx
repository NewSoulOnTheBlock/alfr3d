---
title: 企微智能机器人
description: 将 Alfr3d 接入企业微信智能机器人（长连接模式）
---

> 通过企业微信智能机器人接入Alfr3d，支持企业内部单聊和内部群聊，无需公网 IP，使用 WebSocket 长连接模式，支持Markdown渲染和流式输出。
...
无需提前创建机器人，启动 Alfr3d 项目后打开 Web 控制台（本地链接：http://127.0.0.1:9899/），选择 **通道** 菜单，点击**接入通道**，选择**企微智能机器人**，切换到「扫码接入」模式，使用**企业微信**扫码即可自动完成机器人创建和接入。
