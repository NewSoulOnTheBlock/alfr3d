---
title: 微信客服
description: 将 Alfr3d 接入微信客服（WeChat Customer Service）
---

通过把企业微信自建应用绑定到「微信客服」账号，Alfr3d 可以接管来自外部微信用户的客服咨询，并可在小程序、公众号、视频号及视频号小店等场景中通过链接或二维码触达微信用户。
...
<Tabs>
  <Tab title="Web 控制台">
    启动 Alfr3d 项目后打开 Web 控制台，选择 **通道** 菜单，点击 **接入通道**，选择 **微信客服**，依次填入 Corp ID / Secret / Token / AES Key（端口默认 9888，可改），点击接入即可。
