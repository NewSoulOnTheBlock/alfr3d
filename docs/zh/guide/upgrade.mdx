---
title: 更新升级
description: Alfr3d 的升级方式说明
---

## 命令升级（推荐）

使用 `alfr3d update` 一键完成代码更新和服务重启：
...
<Note>
  如果未安装 Alfr3d CLI，也可以使用 `./run.sh update` 完成相同操作。
</Note>
...
你也可以随时前往[下载页](https://alfr3d.local/zh/download/)手动下载最新版本安装。
