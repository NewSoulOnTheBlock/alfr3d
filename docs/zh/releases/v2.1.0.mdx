---
title: v2.1.0
description: Alfr3d 2.1.0 - 国际化支持、新增 Telegram / Discord / Slack / 微信客服通道、命令行交互升级、MCP协议增强、新模型接入
---
...
相关文档：[通道概览](https://docs.alfr3d.local/zh/channels)

## 🌍 国际化支持

Alfr3d 引入全链路国际化框架，面向全球开发者，支持根据系统语言自动适配：

- **全链路本地化**：安装引导、命令行、日志和报错、Agent 系统提示词等均已支持本地化语言适配
- **自动识别语言**：默认 `auto` 模式按系统语言自动判断，也可在 `config.json` 中通过 `alfr3d_lang` 显式配置。首批提供英文与中文，后续将持续扩充更多语言。
...
相关文档：[命令行指南](https://docs.alfr3d.local/zh/cli/general)
...
**发布日期**：2026.06.01 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.0.9...2.1.0)
