---
title: v2.0.7
description: Alfr3d 2.0.7 - 图像生成技能（六厂商自动路由）、新模型支持、知识库增强、Web 控制台优化及多项修复
---
...
相关文档：[图像生成技能](https://docs.alfr3d.local/skills/image-generation)
...
- **自定义模型厂商**：新增[自定义模型](https://docs.alfr3d.local/models/custom)提供方配置，方便接入本地模型及更多厂商
...
**发布日期**：2026.04.22 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.0.6...2.0.7)
