---
title: v2.0.8
description: Alfr3d 2.0.8 - 飞书渠道全面升级（语音、流式打字机、一键扫码接入）、DeepSeek V4 / 百度千帆支持、定时任务工具优化
---
...
相关文档：[飞书渠道](https://docs.alfr3d.local/channels/feishu)
...
- **百度千帆模型接入**：新增百度千帆厂商，支持 `ernie-5.0`、`ernie-4.5-turbo-128k` 等模型，并支持图像识别工具，相关文档查看 [百度千帆](https://docs.alfr3d.local/models/qianfan)。#2790 Thanks @jimmyzhuu
...
> ⚠️ 飞书一键创建应用依赖 `lark-oapi>=1.5.5`，`alfr3d update` 会自动拉取；手动部署请确保依赖已更新。

**发布日期**：2026.05.06 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.0.7...2.0.8)
