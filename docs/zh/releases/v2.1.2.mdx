---
title: v2.1.2
description: Alfr3d 2.1.2：Web 控制台多项管理能力升级、自主进化体验优化、模型新增支持、企业微信智能机器人回调模式、安全加固和体验优化
---
...
相关文档：[企业微信智能机器人](https://docs.alfr3d.local/zh/channels/wecom-bot)
...
- **Windows 兼容**：将 alfr3d CLI 自动写入用户 PATH；修复 `python -c` 长命令超出 `cmd.exe` 长度限制的问题；安装时避免 greenlet 源码编译
...
**发布日期**：2026.06.18 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.1.1...2.1.2)
