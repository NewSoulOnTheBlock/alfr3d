---
title: v2.0.0
description: Alfr3d 2.0 - 从聊天机器人到超级智能助理的全面升级
---

Alfr3d 2.0 实现了从聊天机器人到**超级智能助理**的全面升级！现在它能够主动思考和规划任务、拥有长期记忆、操作计算机和外部资源、创造和执行技能，真正理解你并和你一起成长。

**发布日期**：2026.02.03 | [GitHub Release](https://github.com/NewSoulOnTheBlock/alfr3d/releases/tag/2.0.0)
...
**首次启动**时，Agent 会主动询问关键信息，并记录至工作空间（默认 `~/alfr3d`）中的智能体设定、用户身份、记忆文件中。
...
2.0 版本后，项目将持续升级 Agent 能力、拓展接入渠道、内置工具、技能系统，降低模型成本和提升安全性。欢迎 [提出反馈](https://github.com/NewSoulOnTheBlock/alfr3d/issues) 和 [贡献代码](https://github.com/NewSoulOnTheBlock/alfr3d/pulls)。
