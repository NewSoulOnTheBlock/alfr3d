---
title: v2.1.3
description: Alfr3d 2.1.3：正式推出桌面客户端（macOS / Windows），知识库文档管理增强，新增 MCP 工具按需检索，繁体中文支持，模型支持，并带来安全与体验的多项改进
---
...
正式推出 **Alfr3d 桌面客户端**，支持 **macOS 与 Windows**，让本地超级 AI 助理真正做到开箱即用。

下载地址：[Alfr3d客户端](https://alfr3d.local/zh/download/)

<img src="https://cdn.jsdelivr.net/gh/NewSoulOnTheBlock/alfr3d-assets@main/screenshots/zh/desktop-chat-demo-zh.png" alt="Alfr3d 桌面客户端" />
...
相关文档：[桌面客户端](https://docs.alfr3d.local/zh/guide/desktop)
...
相关文档：[知识库](https://docs.alfr3d.local/zh/memory/knowledge)

## 🔌 MCP 工具智能检索

针对接入大量 MCP 工具时上下文膨胀的问题，新增 **按需工具检索** 能力，通过 RAG 向量检索按需加载与当前任务相关的 MCP 工具，减少无关工具对上下文的占用。Thanks @fengyl07

相关文档：[MCP 工具](https://docs.alfr3d.local/zh/tools/mcp)
...
相关文档：[模型概览](https://docs.alfr3d.local/zh/models)
...
- **桌面客户端**：前往 [下载页](https://alfr3d.local/zh/download/) 获取最新版本。
- **源码部署**：执行 `alfr3d update` 一键升级，或手动拉取代码后重启。详见 [更新升级文档](https://docs.alfr3d.local/zh/guide/upgrade)。

**发布日期**：2026.07.08 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.1.2...2.1.3)
