---
title: v2.0.6
description: Alfr3d 2.0.6 - 知识库系统、梦境记忆蒸馏、上下文智能压缩、Web 控制台多会话及多项优化
---

## 项目正式更名为 Alfr3d

项目仓库正式从 `alfr3d` 更名为 **Alfr3d**，演进为功能完备的 AI Agent 助理。

- 新地址：[github.com/NewSoulOnTheBlock/alfr3d](https://github.com/NewSoulOnTheBlock/alfr3d)，旧地址 GitHub 会自动重定向
...
相关文档：[知识库](https://docs.alfr3d.local/knowledge)
...
相关文档：[梦境蒸馏](https://docs.alfr3d.local/memory/deep-dream)
...
相关文档：[短期记忆](https://docs.alfr3d.local/memory/context)
...
- **视觉识别优化**：图片识别工具优先使用主模型，支持多模型厂商自动降级。相关文档：[视觉工具](https://docs.alfr3d.local/tools/vision)
...
**发布日期**：2026.04.14 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.0.5...master)
