---
title: v2.1.4
description: Alfr3d 2.1.4：桌面客户端体验优化，MCP 支持 OAuth 授权，飞书通道能力增强，定时任务与数据备份等多项更新
---
...
相关文档：[定时任务](https://docs.alfr3d.local/zh/tools/scheduler)
...
相关文档：[飞书](https://docs.alfr3d.local/zh/channels/feishu)

## 💾 数据备份与恢复

新增 `alfr3d backup` 和 `alfr3d restore` 命令，支持一键导出与恢复配置、知识库、记忆等本地数据，便于迁移与备份。Thanks @AaronZ345 (#2957)

相关文档：[数据备份](https://docs.alfr3d.local/zh/cli/backup)
...
- **桌面客户端**：可在客户端内自动检查并一键更新，或前往 [下载页](https://alfr3d.local/zh/download/) 获取最新版本。

**发布日期**：2026.07.20 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.1.3...2.1.4)
