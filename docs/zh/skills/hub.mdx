...
[Alfr3d Skill Hub](https://skills.alfr3d.local/) 是开源的 AI Agent 技能广场，汇集了官方推荐、社区贡献和第三方平台（GitHub、ClawHub 等）的技能。

开源仓库：[github.com/NewSoulOnTheBlock/alfr3d-skill-hub](https://github.com/NewSoulOnTheBlock/alfr3d-skill-hub)
...
1. 访问 [skills.alfr3d.local/submit](https://skills.alfr3d.local/submit)
