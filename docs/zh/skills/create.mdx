...
Alfr3d 内置了 Skill Creator，可以通过自然语言对话快速创建、安装或更新技能。
...
<Tip>
  详细开发文档可参考 [Skill Creator 说明](https://github.com/NewSoulOnTheBlock/alfr3d/blob/master/skills/skill-creator/SKILL.md)。
</Tip>
