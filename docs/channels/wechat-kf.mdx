...
description: Integrate Alfr3d into WeChat Customer Service
---

By binding a WeCom custom enterprise app to a WeChat Customer Service account, Alfr3d can take over inbound inquiries from external WeChat users and serve them through links or QR codes embedded in WeChat Mini Programs, Official Accounts, Video Channels, and Video Channel stores.
...
<Tabs>
  <Tab title="Web Console">
    Start the Alfr3d project and open the Web Console. Go to the **Channels** menu, click **Connect**, choose **WeChat Customer Service**, fill in Corp ID / Secret / Token / AES Key (port defaults to 9888, configurable), and click Connect.

    <img src="https://cdn.link-ai.tech/doc/alfr3d-weixinkefu-web-control.png" width="800"/>
  </Tab>
