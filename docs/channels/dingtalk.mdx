---
title: DingTalk
description: Integrate Alfr3d into DingTalk application
---

Integrate Alfr3d into DingTalk by creating an intelligent robot app on the DingTalk Open Platform.
