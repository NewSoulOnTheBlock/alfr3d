---
title: Feishu (Lark)
description: Integrate Alfr3d into Feishu via a custom enterprise app
---

> Integrate Alfr3d into Feishu via a custom enterprise app. Supports p2p chat and group chat (@bot), uses WebSocket long connection (no public IP needed), supports streaming typewriter replies and voice messages.
...
1. After Alfr3d is running, go to **Events & Callbacks** in the Feishu Developer Platform, choose **Long Connection** mode and save:
