---
title: QQ Bot
description: Connect Alfr3d to QQ Bot (WebSocket long connection)
---

> Connect Alfr3d via QQ Open Platform's bot API, supporting QQ direct messages, group chats (@bot), guild channel messages, and guild DMs. No public IP required — uses WebSocket long connection.
