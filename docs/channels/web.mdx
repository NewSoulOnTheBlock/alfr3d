---
title: Web Console
description: Use Alfr3d through the Web Console
---

The Web Console is Alfr3d's default channel. It runs automatically once started, letting you chat with the Agent in a browser and manage models, skills, memory, channels, and other configuration online.
