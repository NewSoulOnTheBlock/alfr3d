...
description: Channels supported by Alfr3d and their capability matrix
---

Alfr3d supports multiple chat channels. Switch between them at startup via `channel_type`. The Web Console is enabled by default and can run in parallel with other channels.
