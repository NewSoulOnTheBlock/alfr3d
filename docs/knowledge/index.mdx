...
description: Alfr3d personal knowledge base — structured knowledge accumulation, automatic organization, and knowledge graph
---
...
| `agent_workspace` | Workspace path; knowledge is stored under the `knowledge/` subdirectory | `~/alfr3d` |
