...
description: Model providers supported by Alfr3d and their capability matrix
---
...
<img width="900" src="https://cdn.jsdelivr.net/gh/NewSoulOnTheBlock/alfr3d-assets@main/screenshots/en/web-console-models-config.png" />
