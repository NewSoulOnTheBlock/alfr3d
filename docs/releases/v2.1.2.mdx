---
title: v2.1.2
description: Alfr3d 2.1.2 - Web Console management upgrades, Self-Evolution improvements, new models, WeCom smart-bot callback mode, and security hardening
---

🌐 [English](https://docs.alfr3d.local/releases/v2.1.2) | [中文](https://docs.alfr3d.local/zh/releases/v2.1.2)
...
Documentation: [WeCom Smart Bot](https://docs.alfr3d.local/channels/wecom-bot)
...
- **Windows compatibility**: Persist the alfr3d CLI directory to the user PATH; fixed `python -c` long commands exceeding the `cmd.exe` length limit; avoid building greenlet from source during install
...
**Release Date**: 2026.06.18 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.1.1...2.1.2)
