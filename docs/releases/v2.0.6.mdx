---
title: v2.0.6
description: Alfr3d 2.0.6 - Knowledge Base, Deep Dream Memory Distillation, Smart Context Compression, Web Console Multi-Session and More
---

## Project Renamed to Alfr3d

The repository has been officially renamed from `alfr3d` to **Alfr3d**, evolving into a full-featured AI Agent assistant.

- New URL: [github.com/NewSoulOnTheBlock/alfr3d](https://github.com/NewSoulOnTheBlock/alfr3d) — GitHub auto-redirects the old URL
...
Docs: [Knowledge Base](https://docs.alfr3d.local/en/knowledge)
...
Docs: [Deep Dream](https://docs.alfr3d.local/en/memory/deep-dream)
...
Docs: [Short-term Memory](https://docs.alfr3d.local/en/memory/context)
...
- **Vision optimization**: Image recognition tool prefers the primary model with automatic multi-provider fallback. Docs: [Vision Tool](https://docs.alfr3d.local/en/tools/vision)
...
**Release Date**: 2026.04.14 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.0.5...master)
