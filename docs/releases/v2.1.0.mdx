---
title: v2.1.0
description: Alfr3d 2.1.0 - Internationalization, new Telegram / Discord / Slack / WeChat Customer Service channels, CLI interaction upgrades, MCP protocol enhancements and new models
---

🌐 [English](https://docs.alfr3d.local/releases/v2.1.0) | [中文](https://docs.alfr3d.local/zh/releases/v2.1.0)
...
- **Slack Bot**: Connect a Slack bot and bring Alfr3d into your team's workflow
...
Documentation: [Channels Overview](https://docs.alfr3d.local/en/channels)

## 🌍 Internationalization

Alfr3d introduces an end-to-end internationalization framework built for developers worldwide, adapting automatically based on the system language:

- **End-to-end localization**: The install flow, CLI, logs and error messages, agent system prompts and more are all localized
- **Automatic language detection**: The default `auto` mode infers the language from the system locale, or you can set `alfr3d_lang` explicitly in `config.json`. English and Chinese ship first, with more languages to follow
...
Documentation: [CLI Guide](https://docs.alfr3d.local/en/cli/general)
...
Documentation: [MCP Tools](https://docs.alfr3d.local/en/tools/mcp)
...
**Release Date**: 2026.06.01 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.0.9...2.1.0)
