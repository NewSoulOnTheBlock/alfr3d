---
title: v2.1.4
description: "Alfr3d 2.1.4: Desktop experience improvements, MCP OAuth authorization, Feishu channel enhancements, plus scheduler, data backup, and new models"
---

🌐 [English](https://docs.alfr3d.local/releases/v2.1.4) | [中文](https://docs.alfr3d.local/zh/releases/v2.1.4)
...
Download: [Alfr3d Desktop](https://alfr3d.local/download/)

Docs: [Desktop Client](https://docs.alfr3d.local/guide/desktop)
...
Docs: [MCP Tools](https://docs.alfr3d.local/tools/mcp)
...
Docs: [Scheduled Tasks](https://docs.alfr3d.local/tools/scheduler)
...
Docs: [Feishu](https://docs.alfr3d.local/channels/feishu)

## 💾 Data Backup & Restore

Added the `alfr3d backup` and `alfr3d restore` commands to export and restore local data — configuration, knowledge base, memory, and more — with one command, making migration and backup easy. Thanks @AaronZ345 (#2957)

Docs: [Data Backup](https://docs.alfr3d.local/cli/backup)
...
Docs: [Models](https://docs.alfr3d.local/models)
...
- **Source deployment**: run `alfr3d update` for a one-click upgrade, or pull the latest code and restart. See the [upgrade guide](https://docs.alfr3d.local/guide/upgrade).
- **Desktop client**: check for updates and update with one click inside the client, or get the latest version from the [download page](https://alfr3d.local/download/).

**Release date**: 2026.07.20 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.1.3...2.1.4)
