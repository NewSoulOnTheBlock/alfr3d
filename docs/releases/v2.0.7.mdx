---
title: v2.0.7
description: Alfr3d 2.0.7 - Image Generation Skill (6-provider auto-routing), new models, knowledge base enhancements, Web Console improvements and bug fixes
---
...
Docs: [Image Generation Skill](https://docs.alfr3d.local/en/skills/image-generation)
...
**Release Date**: 2026.04.22 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.0.6...master)
