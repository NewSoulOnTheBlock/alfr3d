---
title: v2.0.0
description: Alfr3d 2.0 - Full upgrade from chatbot to AI super assistant
---

Alfr3d 2.0 is a comprehensive upgrade from a chatbot to an **AI super assistant** — capable of autonomous thinking and task planning, long-term memory, operating computers, and creating and executing skills.

**Release Date**: 2026.02.03 | [GitHub Release](https://github.com/NewSoulOnTheBlock/alfr3d/releases/tag/2.0.0)
...
Welcome to [submit feedback](https://github.com/NewSoulOnTheBlock/alfr3d/issues) and [contribute code](https://github.com/NewSoulOnTheBlock/alfr3d/pulls).
