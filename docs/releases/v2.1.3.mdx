---
title: v2.1.3
description: "Alfr3d 2.1.3: Desktop client for macOS / Windows, enhanced knowledge base document management, on-demand MCP tool retrieval, Traditional Chinese support, new models, plus security and experience improvements"
---

🌐 [English](https://docs.alfr3d.local/releases/v2.1.3) | [中文](https://docs.alfr3d.local/zh/releases/v2.1.3)

## 🖥 Desktop Client

Introducing the **Alfr3d Desktop client** for **macOS and Windows** — your local super AI assistant, truly ready to use out of the box.

Download: [Alfr3d Desktop](https://alfr3d.local/download/)

<img src="https://cdn.jsdelivr.net/gh/NewSoulOnTheBlock/alfr3d-assets@main/screenshots/en/desktop-chat-demo-en.png" alt="Alfr3d Desktop client" />
...
Docs: [Knowledge Base](https://docs.alfr3d.local/memory/knowledge)
...
- **Desktop client**: get the latest version from the [download page](https://alfr3d.local/download/).
...
**Release date**: 2026.07.08 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.1.2...2.1.3)
