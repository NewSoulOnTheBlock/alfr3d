---
title: v2.1.5
description: "Alfr3d 2.1.5: workspace with file preview, a systematic pass over the core tools, context management improvements, and one-click prompt optimization"
---

🌐 [English](https://docs.alfr3d.local/releases/v2.1.5) | [中文](https://docs.alfr3d.local/zh/releases/v2.1.5)
...
<img src="https://cdn.jsdelivr.net/gh/NewSoulOnTheBlock/alfr3d-assets@main/screenshots/en/workspace-file-preview-demo-en.png" width="800" />
...
Docs: [File Search](https://docs.alfr3d.local/tools/search-files)
...
Docs: [Context Management](https://docs.alfr3d.local/memory/context)
...
- **Credential file protection**: fixed the `edit` tool bypassing credential protection to read and write `~/.alfr3d/.env`.
...
**Release date**: 2026.07.28 | [Full Changelog](https://github.com/NewSoulOnTheBlock/alfr3d/compare/2.1.4...2.1.5)
