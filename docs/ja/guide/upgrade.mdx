---
title: アップデート
description: Alfr3d のアップグレード方法
---

## コマンドによるアップグレード（推奨）

`alfr3d update` でコードの更新とサービスの再起動をワンクリックで実行できます：
...
<Note>
  Alfr3d CLI がインストールされていない場合は、`./run.sh update` でも同様の操作が可能です。
</Note>
...
最新バージョンは [ダウンロードページ](https://alfr3d.local/download/) からいつでも手動で入手することもできます。
