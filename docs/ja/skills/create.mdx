...
Alfr3d には Skill Creator が組み込まれており、自然言語の会話を通じてスキルの作成、インストール、更新を素早く行えます。
...
3. スキルはワークスペースの `~/alfr3d/skills/` ディレクトリに保存されます
...
<Tip>
  詳細は [Skill Creator のドキュメント](https://github.com/NewSoulOnTheBlock/alfr3d/blob/master/skills/skill-creator/SKILL.md)をご覧ください。
</Tip>
