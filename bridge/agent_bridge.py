"""
Agent Bridge - Integrates Agent system with existing ALFR3D bridge
"""
...
class AgentLLMModel(LLMModel):
    ...
    def call(self, request: LLMRequest):
        """
        Call the model using ALFR3D's bot infrastructure
        """
        try:
    ...
    def call_stream(self, request: LLMRequest):
        """
        Call the model with streaming using ALFR3D's bot infrastructure
        """
        try:
            if hasattr(self.bot, 'call_with_tools'):
...
class AgentBridge:
    """
    Bridge class that integrates super Agent with ALFR3D
    ...
    def create_agent(self, system_prompt: str, tools: List = None, **kwargs) -> Agent:
        """
        Create the super agent with ALFR3D integration
        ...
        Returns:
            Agent instance
        """
        # Create LLM model that uses ALFR3D's bot infrastructure
    ...
    def agent_reply(self, query: str, context: Context = None, 
        ...
        Args:
            query: User query
            context: ALFR3D context (optional, contains session_id for user isolation)
        ...
        try:
            ...
            # Post-message hot-reload: detect edits to ~/alfr3d/mcp.json and
    ...
    def _migrate_config_to_env(self, workspace_root: str):
        ...
        env_file = expand_path("~/.alfr3d/.env")
