"""Shared utilities for alfr3d CLI."""
...
def get_project_root() -> str:
    """Get the Alfr3d project root directory."""
...
def get_cli_language() -> str:
    ...
    Reads the `alfr3d_lang` field from config.json (defaults to "auto") and runs
    ...
    try:
        ...
        configured = load_config_json().get("alfr3d_lang", "auto")
...
SKILL_HUB_API = "https://skills.alfr3d.local/api"
