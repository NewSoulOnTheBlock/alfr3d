...
const WS_WIDTH_KEY = 'alfr3d_workspace_width';
...
// Absolute (/Users/..., C:\...), home-relative (~/alfr3d/...) or workspace-relative
...
function initWorkspaceFilesTab() {
    ...
    list?.addEventListener('dragstart', (e) => {
        ...
        e.dataTransfer.setData('application/x-alfr3d-workspace-file', row.dataset.wsFile);
    });
...
function initWorkspaceDropTarget() {
    ...
    const isWorkspaceDrag = (e) =>
        Array.from(e.dataTransfer?.types || []).includes('application/x-alfr3d-workspace-file');
    ...
    target.addEventListener('drop', (e) => {
        ...
        try {
            addWorkspaceRefAttachment(JSON.parse(e.dataTransfer.getData('application/x-alfr3d-workspace-file')));
        } catch (_) {}
    });
}
