...
#
# Output: desktop/build/dist/alfr3d-backend/  (folder with the executable)
set -euo pipefail
...
pyinstaller "$BUILD_DIR/alfr3d-backend.spec" \
  --noconfirm \
  --distpath "$BUILD_DIR/dist" \
  --workpath "$BUILD_DIR/build-work"

echo ""
echo "==> Done. Bundle at: $BUILD_DIR/dist/alfr3d-backend/"
du -sh "$BUILD_DIR/dist/alfr3d-backend/" 2>/dev/null || true
echo "==> Smoke test: ALFR3D_DESKTOP=1 \"$BUILD_DIR/dist/alfr3d-backend/alfr3d-backend\""
