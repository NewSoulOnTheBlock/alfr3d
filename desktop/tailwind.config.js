...
// When '@product' points outside this project (ALFR3D_PRODUCT_DIR), scan that
// directory too so classes used only there still get generated.
const productContent = process.env.ALFR3D_PRODUCT_DIR
  ? [path.join(process.env.ALFR3D_PRODUCT_DIR, '**/*.{tsx,ts}')]
  : []
