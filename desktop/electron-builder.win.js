 ...
 * alfr3d-backend.exe) and the NSIS installer. We deliberately do NOT add an
 ...
 * (unsigned dev/dry builds keep working). When ALFR3D_SIGN_DRY_RUN=1 we pass
...
const DRY_RUN = !!process.env.ALFR3D_SIGN_DRY_RUN
...
// includes the packaged backend (extraResources/backend/alfr3d-backend.exe)
