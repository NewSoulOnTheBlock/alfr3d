 ...
 * pre-build backend source dir (build/dist/alfr3d-backend, produced by
...
// Contents/Resources/backend/alfr3d-backend (see extraResources).
const backendSrc = path.join(__dirname, 'build', 'dist', 'alfr3d-backend')
const inAppPrefix = path.join('Contents', 'Resources', 'backend', 'alfr3d-backend')
