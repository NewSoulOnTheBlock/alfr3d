...
//
// Themes are NOT bundled into the app. They live in ~/.alfr3d/themes/<id>/
...
// ~/.alfr3d/themes. This keeps the app bundle free of theme assets.
...
// Runtime registry: default first, then whatever was loaded from ~/.alfr3d.
