...
// language-agnostic.
const SKILL_HUB_URL = 'https://skills.alfr3d.local/'
// GitHub issues — where users report bugs / request features.
const FEEDBACK_URL = 'https://github.com/NewSoulOnTheBlock/alfr3d/issues'

const websiteUrl = () => (getLang() === 'zh' ? 'https://alfr3d.local/zh' : 'https://alfr3d.local')
const docsUrl = () => (getLang() === 'zh' ? 'https://docs.alfr3d.local/zh' : 'https://docs.alfr3d.local')
