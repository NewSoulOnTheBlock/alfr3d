...
// can set ALFR3D_PRODUCT_DIR to point at another module instead.
const productDir =
  process.env.ALFR3D_PRODUCT_DIR || path.resolve(__dirname, 'src/renderer/src/product/default')
...
const sharedDepAliases = process.env.ALFR3D_PRODUCT_DIR
  ? {
