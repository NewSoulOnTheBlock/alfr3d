...
class TaskStore:
    ...
    def __init__(self, store_path: str = None):
        ...
        Args:
            store_path: Path to tasks.json file. Defaults to ~/alfr3d/scheduler/tasks.json
        """
        if store_path is None:
            # Default to ~/alfr3d/scheduler/tasks.json
            home = expand_path("~")
            store_path = os.path.join(home, "alfr3d", "scheduler", "tasks.json")
