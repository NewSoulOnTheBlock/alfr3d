...
_DEFAULT_USER_DATA_DIR = "~/.alfr3d/browser_profile"
...
class BrowserService:
    ...
    def _launch_browser(self):
        ...
        # bundled-Chromium fallback finds the browser downloaded to ~/.alfr3d.
        try:
        ...
        try:
            ...
            if "singletonlock" in msg or "profile" in msg or "lock" in msg:
                raise RuntimeError(
                    ...
                    "Close the other Chromium / alfr3d instance, or set a different "
        ...
        try:
            if ref is not None:
                result = page.evaluate(f"""
                    () => {{
                        const el = window.__alfr3dRefMap && window.__alfr3dRefMap[{ref}];
