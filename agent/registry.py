...
one complete Alfr3d workspace. Runtime, routing, and persistence layers build
...
class AgentProfile:
    """Configuration for one complete Alfr3d workspace."""
...
class AgentRegistry:
    ...
    def from_config(cls, settings: Mapping[str, Any]) -> "AgentRegistry":
        ...
        if raw_agents is None or raw_agents == []:
            workspace = settings.get("agent_workspace", "~/alfr3d")
