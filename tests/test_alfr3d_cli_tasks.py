...
plugins.instance.current_plugin_path = os.path.join(os.getcwd(), "plugins", "alfr3d_cli")
try:
    from plugins.alfr3d_cli.alfr3d_cli import KNOWN_COMMANDS
finally:
    plugins.instance.current_plugin_path = _old_plugin_path

Alfr3dCliPlugin = plugins.instance.plugins["ALFR3D_CLI"]
