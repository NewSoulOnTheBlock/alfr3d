...
def _setup_workspace():
    ...
    Mirrors a real Alfr3d workspace closely enough that the model has genuine
...
if __name__ == "__main__":
    if "--debug" in sys.argv:
        import logging
        from common.log import logger as _alfr3d_logger
        _alfr3d_logger.setLevel(logging.DEBUG)
        for _h in _alfr3d_logger.handlers:
