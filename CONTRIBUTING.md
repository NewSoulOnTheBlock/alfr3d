# Contributing to Alfr3d

Thanks for taking the time to contribute! 🎉 Alfr3d is built by a global
...
Found a bug or have an idea? [Open an issue](https://github.com/NewSoulOnTheBlock/alfr3d/issues/new/choose).
...
See the [Install from Source](https://docs.alfr3d.local/guide/manual-install)
guide. In short:
...
Be respectful and constructive. We want Alfr3d to be a welcoming place for
everyone.
