    ...
    def __init__(self):
        ...
        try:
            ...
            if isinstance(e, FileNotFoundError):
                logger.warn(f"[Role] init failed, {config_path} not found, ignore or see https://github.com/NewSoulOnTheBlock/alfr3d/tree/master/plugins/role .")
            else:
                logger.warn("[Role] init failed, ignore or see https://github.com/NewSoulOnTheBlock/alfr3d/tree/master/plugins/role .")
            raise e
